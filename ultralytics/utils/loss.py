...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max=16,mpdiou=False,siou=False,eiou=False,shapeiou=False,giou=False,diou=False, nwd_loss=False, iou_ratio=0.5):
...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk=10):  # model must be de-paralleled
        ...
        self.bbox_loss = BboxLoss(m.reg_max,mpdiou=self.mpdiou,siou=self.siou,eiou=self.eiou,shapeiou=self.shapeiou,giou=self.giou,diou=self.diou,nwd_loss=self.nwdloss,iou_ratio=self.iou_ratio).to(device)
